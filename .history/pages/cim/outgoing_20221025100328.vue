    ...
    async getFirstBreaker() {
      ...
      class 路径类 {
        ...
        static async 获取路径(svg) {
          ...
          console.log(structureData.result.xml);
        ...
        获取下级设备({ id, array = [], deep = 1 }) {
          ...
          let idArray = [];
          for (const ixml of this.structure.xml) {
            idArray.push(ixml.from.id);
          }
          console.log('***');
          console.log(idArray);
      ...
      const structureData = await (await 路径类.获取路径('PD_10000100_99217')).获取下级设备('PD_31100000_64019');
