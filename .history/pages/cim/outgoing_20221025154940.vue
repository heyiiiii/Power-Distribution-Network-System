  ...
  methods: {
    ...
    async getFirstBreaker() {
      ...
      for (const busSvg of busSvgList) {
        let resultData1 = (await 路径类.获取路径('PD_10000100_100833')).获取下级设备({ id: busSvg });
        let resultData2 = (await 路径类.获取路径('PD_10000100_100833')).获取下级设备({ id: busSvg });
        let resultData3 = (await 路径类.获取路径('PD_10000100_100833')).获取下级设备({ id: busSvg });
