...
import pathHelper from '~/plugins/path';
export default {
  ...
  methods: {
    ...
    getFirstBreaker(busSvgs) {
      const pathGuider = new pathHelper();
      const pathData = pathGuider.获取路径(busSvgs);
      console.log('查到路径\n');
