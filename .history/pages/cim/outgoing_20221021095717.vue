...
import * as tools from '~/plugins/path';
export default {
  ...
  methods: {
    ...
    async getFirstBreaker(baseDate, busSvgs, busesId) {
      const { data: structureData } = await this.$axios.$get('/models/xml-structure/' + busSvgs);
      console.log('查询到路径\n');
      console.log(structureData);

      // const pathBase = new tools.Base(baseDate);
      // console.log(pathBase);

      // const PathGuider = new tools.路径类(busSvgs);
      // console.log('查到路径类\n');
      // console.log(PathGuider);

      // const upPath = PathGuider.获取上级路径(busesId);
      // console.log('获取到上级路径\n');
      // console.log(upPath);

      // const downStructor = PathGuider.获取下级设备(busesId);
      // console.log('获取到下级设备\n');
      // console.log(downStructor);
      // const { breakers: [] } = PathGuider.获取下级设备;
