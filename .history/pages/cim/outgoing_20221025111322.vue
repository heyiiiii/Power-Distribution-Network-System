...
export default {
  ...
  methods: {
    ...
    async getFirstBreaker() {
      ...
      for (const iSvg of lineSvgList) {
        const resultData = await (await 路径类.获取路径('PD_10000100_1501724403')).获取下级设备(iSvg);
      ...
      // const structureData = await (await 路径类.获取路径('PD_10000100_99217')).获取下级设备('PD_31100000_63727');
