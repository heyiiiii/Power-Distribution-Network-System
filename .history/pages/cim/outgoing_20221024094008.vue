...
export default {
  ...
  methods: {
    ...
    async getFirstBreaker() {
      const baseData = new Base('PD_30000000_60894', '#PD_30000000_60894', '30000000_60894', 'baseData1');
      console.log(baseData);
      // let basedDate = new Base('PD_31100000_64019');
      const svg = 'PD_10000100_99217';
      const { data: structureData } = await this.$axios.get('/models/xml-structure/' + svg);
      console.log(structureData);
      const newDathData = new 路径类(structureData.result ? structureData.result.structure : []);
      console.log(newDathData);
      let deep = 1;
      let array = [];
