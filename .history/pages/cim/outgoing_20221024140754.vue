...
// import { 路径类 } from '~/assets/js/path';
...
export default {
  ...
  methods: {
    ...
    getFirstBreaker() {
      ...
      const baseData = new Base('PD_30000000_60894', 'PD_30000000_60894', '30000000_60894');
      const pathData = new 路径类().获取下级设备('PD_31100000_64019');
