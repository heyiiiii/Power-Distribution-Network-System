...
export default {
  ...
  methods: {
    ...
    async getFirstBreaker() {
      ...
      const testData = await this.$axios.get('/models/xml-structure/' + svg);
      console.log('这里\n');
      console.log(testData);
      console.log(lineSvgList);
      const structureData = await 路径类.获取路径('PD_10000100_41697');
      console.log(new 路径类(structureData.result));
