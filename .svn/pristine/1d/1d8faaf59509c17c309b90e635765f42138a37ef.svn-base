      ...
      <table class="sel-table">
        <tbody>
          ...
          <tr>
            <th>地区</th>
            <td>
              <el-checkbox :indeterminate="checkBox.indeterminate" v-model="checkBox.checkAll" type="success"
                class="clear-line" @change="onChangeCheckAllAreas">
                全选
              </el-checkbox>
      ...
      <div class="list-content">
        <div v-for="(row, rowIndex) in substationTable" :key="rowIndex">
          <div class="sel-row-button">
            <el-button v-for="(sub, index) in row" :key="index" @click="onClickSubstation(sub)" class="sel-sub-button">
        ...
        <div v-if="showTable">
          ...
          <el-table :data="lineList" size="mini" class="m-t-20">
            ...
            <el-table-column label="操作">
              <template slot-scope="scope">
                <span class="sel-span-font" @click="onOpenGraph(scope.row)">打开图形</span>
              </template>
            </el-table-column>
          </el-table>
        </div>
