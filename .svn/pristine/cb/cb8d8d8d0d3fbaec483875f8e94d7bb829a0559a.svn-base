...
// The following functions are used by a group of regular figures that are defined below:
  ...
  go.Shape.defineFigureGenerator('FramedRectangle', function(shape, w, h) {
    ...
    if (isNaN(param1)) {
      param1 = 8;
    } // default values PARAMETER 1 is for WIDTH
    if (isNaN(param2)) {
      param2 = 8;
    } // default values PARAMETER 2 is for HEIGHT
  ...
  go.Shape.defineFigureGenerator('Pie', function(shape, w, h) {
    ...
    if (isNaN(param1)) {
      param1 = 0;
    } // default values PARAMETER 1 is for Start Angle
    if (isNaN(param2)) {
      param2 = 315;
    } // default values PARAMETER 2 is for Sweep Angle
...
// SplitEndArrow with absolutes instead of scaling
  ...
  go.Shape.defineFigureGenerator('MessageFromUser', function(shape, w, h) {
    ...
    if (isNaN(param1)) {
      param1 = .7;
    } // How far from the right the point is
    var fig = new go.PathFigure(0, 0, true);
    geo.add(fig);
  ...
  go.Shape.defineFigureGenerator('MicroformProcessing', function(shape, w, h) {
    ...
    if (isNaN(param1)) {
      param1 = .25;
    } // How far from the top/bottom the points are
    var fig = new go.PathFigure(0, 0, true);
    geo.add(fig);
  ...
  go.Shape.defineFigureGenerator('PrimitiveFromCall', function(shape, w, h) {
    ...
    if (isNaN(param1)) {
      param1 = .1;
    } // Distance of left line from left
    if (isNaN(param2)) {
      param2 = .3;
    } // Distance of point from right
    var fig = new go.PathFigure(0, 0, true);
    geo.add(fig);
  ...
  go.Shape.defineFigureGenerator('PrimitiveToCall', function(shape, w, h) {
    ...
    if (isNaN(param2)) {
      param2 = .3;
    } // Distance of top and bottom right corners from right
    var fig = new go.PathFigure(0, 0, true);
    geo.add(fig);
  ...
  go.Shape.defineFigureGenerator('TransmittalTape', function(shape, w, h) {
    ...
    if (isNaN(param1)) {
      param1 = .1;
    } // Bottom line's distance from the point on the triangle
    var fig = new go.PathFigure(0, 0, true);
    geo.add(fig);
